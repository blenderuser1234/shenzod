...
bot = telebot.TeleBot('7717577857:AAFONFKxB5oRyMZd8syXiuO85U9vS1J3r9M')
...
def handle_bgmi(message):
 ...
 🛒 𝑫𝑴 𝑯𝑬𝑹𝑬 𝑻𝑶 𝑩𝑼𝒀 𝑨𝑪𝑪𝑬𝑺𝑺 :- @dronzerX1"""
...
def welcome_start(message):
    ...
    response = f'''𝑾𝑬𝑳𝑪𝑶𝑴𝑬 𝑻𝑶 𝑺𝑷𝑰𝑫𝒀𝑪𝑹𝑨𝑲𝑺 𝑫𝑫𝒐𝑺 𝑩𝑶𝑻:- @dronzerX1
